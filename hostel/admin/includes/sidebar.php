<nav class="ts-sidebar">
			<ul class="ts-sidebar-menu">
				...
				<li><a href="check-register.php"><i class="fa fa-user"></i>Check Registration</a></li>
				...
				<li><a href="manage-reg-student.php"><i class="fa fa-users"></i>Manage Registered Students</a></li>
				<li><a href="show-complaint.php"><i class="fa fa-user"></i>Check Complaint</a></li>
				<li><a href="show-feedback.php"><i class="fa fa-user"></i>Check Feedback</a></li>
