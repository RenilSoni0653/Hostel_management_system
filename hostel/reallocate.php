...
$query="insert into  registration(roomno,seater,feespm,foodstatus,stayfrom,duration,total,course,regno,firstName,middleName,lastName,gender,contactno,emailid,egycontactno,guardianName,guardianRelation,guardianContactno,corresAddress,corresCIty,corresState,corresPincode,pmntAddress,pmntCity,pmnatetState,pmntPincode) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('iiiisiisissssisississsisssi',$roomno,$seater,$feespm,$foodstatus,$stayfrom,$duration,$total,$course,$regno,$fname,$mname,$lname,$gender,$contactno,$emailid,$emcntno,$gurname,$gurrelation,$gurcntno,$caddress,$ccity,$cstate,$cpincode,$paddress,$pcity,$pstate,$ppincode);
$stmt->execute();
...
<div class="col-sm-8">
<input type="text" name="fpm" id="fpm"  class="form-control" disabled>
</div>
</div>
...
<div class="col-sm-8">
<input type="radio" value="0" name="foodstatus" checked="checked" id="f0" > Without Food
<input type="radio" value="1" name="foodstatus" id="f1" onclick="val()"> With Food(Rs 2000.00 Per Month Extra)
</div>
</div>	
...
<div class="col-sm-8">
<select name="duration" id="duration" class="form-control" onclick="val()">
...
<div class="col-sm-8">
<input type="text" name="total" id="total"  class="result form-control" disabled>
...
$(document).ready(function() {
		...
		if(document.getElementById('f1').checked){
			total=(parseInt(fee)+2000)*parseInt(time);
		}
		else
		{
			total=parseInt(fee)*parseInt(time);
		}
