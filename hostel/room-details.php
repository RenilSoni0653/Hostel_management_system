...
<td><a href="javascript:void(0);"  onClick="popUpWindow('http://localhost/Hostel management System Project/hostel/full-profile.php?id=<?php echo $row->emailid;?>');" title="View Full Details">Print Data</a></td>
</tr>
<tr>
...
<tr>
<form method="POST" action="reallocate.php">
<td colspan="6"><center><button name="reallocate">Re-allocate</button></center></td>
</form>
</tr>
<?php
$cnt=$cnt+1;
